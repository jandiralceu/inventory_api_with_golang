...
CREATE TABLE public.inventory_transactions (
    ...
    quantity_balance integer NOT NULL,
...
--
-- Name: inventory uk_inventory_product_warehouse; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_inv_trans_inventory_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_inv_trans_inventory_id ON public.inventory_transactions USING btree (inventory_id);


--
-- Name: idx_inv_trans_product_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_inv_trans_product_id ON public.inventory_transactions USING btree (product_id);


--
-- Name: idx_inv_trans_warehouse_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_inv_trans_warehouse_id ON public.inventory_transactions USING btree (warehouse_id);
...
CREATE INDEX idx_inventory_location ON public.inventory USING btree (location_code);


--
-- Name: idx_inventory_metadata; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_inventory_metadata ON public.inventory USING gin (metadata);
...
--
-- Name: idx_inventory_warehouse_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_products_images; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_suppliers_address; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_suppliers_address ON public.suppliers USING gin (address);
...
--
-- Name: idx_warehouses_address; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warehouses_address ON public.warehouses USING gin (address);
...
--
-- Name: idx_warehouses_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warehouses_slug ON public.warehouses USING btree (slug);
